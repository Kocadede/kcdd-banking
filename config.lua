...
Config.CustomDrawText = {

    {id = 277, x = -54.44, y = -1097.06, z = 26.54},
}
...
Config.ATM = {
    ...
    {id = 277, x= 147.76020812988, y = -1035.7926025391, z = 29.342926025391},
    {id = 277, x = 146.01432800293, y=-1035.1616210938, z=29.344818115234},
    {id = 277, x = -54.47, y=-1097.05, z=26.42},
    {id = 277, x = 1167.02, y = -456.32, z = 66.79},
    {id = 277, x = -386.733, y = 6045.953, z = 31.501},
    {id = 277, x = 472.3660, y = -1001.58, z = 30.691},
    ...
    {id = 277, x = 315.0986, y = -593.700, z = 43.283},         
    {id = 277, x = -42.5671, y = -1108.37, z = 26.437 },
    {id = 277, x = 315.2575, y = -593.680, z = 43.284 },
}


Config.Text = {
    ["bank_blip"] = "Bank",
    ["openbank"] = "Type /atm to access your bank"
}

function sendNotif(text, type)
